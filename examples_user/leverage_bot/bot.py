...
from handlers import (
    cmd_start, cmd_help, cmd_vix, cmd_scan, cmd_weekly,
...
def main():
    persistence = PicklePersistence(filepath=os.path.join(_DIR, 'bot_data.pkl'))
    app = Application.builder().token(TELEGRAM_BOT_TOKEN).post_init(post_init).persistence(persistence).build()
